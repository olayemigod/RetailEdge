...
HOME_WORKSPACE_ITEMS: tuple[WorkspaceHomeItem, ...] = (
	...
	WorkspaceHomeItem(
		"POS Opening", "DocType", POSNEXT_OPENING_SHIFT, "Sales & POS", 20, "cashier", "POS Runtime", "Grey"
	),
	WorkspaceHomeItem(
		"POS Closing", "DocType", POSNEXT_CLOSING_SHIFT, "Sales & POS", 30, "cashier", "POS Runtime", "Grey"
	),
	WorkspaceHomeItem(
		"Sales Invoice", "DocType", "Sales Invoice", "Sales & POS", 40, "operations", "ERPNext Link", "Grey"
	),
	WorkspaceHomeItem(
		"Customer", "DocType", "Customer", "Sales & POS", 50, "cashier", "ERPNext Link", "Grey"
	),
	WorkspaceHomeItem(
		"Payment Entry",
		"DocType",
	...
	WorkspaceHomeItem(
		"Item", "DocType", "Item", "Inventory & Purchasing", 10, "stock", "ERPNext Link", "Grey"
	),
	WorkspaceHomeItem(
		"Warehouse", "DocType", "Warehouse", "Inventory & Purchasing", 20, "stock", "ERPNext Link", "Grey"
	),
	WorkspaceHomeItem(
		"Stock Entry", "DocType", "Stock Entry", "Inventory & Purchasing", 30, "stock", "ERPNext Link", "Grey"
	),
	WorkspaceHomeItem(
	...
	WorkspaceHomeItem(
		"Stock Ledger", "Report", "Stock Ledger", "Reports & Insights", 10, "stock", "ERPNext Link", "Grey"
	),
	WorkspaceHomeItem(
		"Stock Balance", "Report", "Stock Balance", "Reports & Insights", 20, "stock", "ERPNext Link", "Grey"
	),
	WorkspaceHomeItem(
		"Stock Projected Qty",
		"Report",
	...
	WorkspaceHomeItem(
		"Stock Ageing", "Report", "Stock Ageing", "Reports & Insights", 40, "stock", "ERPNext Link", "Grey"
	),
	WorkspaceHomeItem(
	...
	WorkspaceHomeItem(
		"Reconciliation Readiness Review",
		"Report",
	...
	WorkspaceHomeItem(
		"Item Group", "DocType", "Item Group", "Setup & Configuration", 80, "admin", "ERPNext Link", "Grey"
	),
	WorkspaceHomeItem("UOM", "DocType", "UOM", "Setup & Configuration", 90, "admin", "ERPNext Link", "Grey"),
	WorkspaceHomeItem(
		"Batch", "DocType", "Batch", "Setup & Configuration", 100, "admin", "ERPNext Link", "Grey"
	),
	WorkspaceHomeItem(
		"Serial No", "DocType", "Serial No", "Setup & Configuration", 110, "admin", "ERPNext Link", "Grey"
	),
	WorkspaceHomeItem(
		"Bank Match Batch Jobs",
		"DocType",
	...
	WorkspaceHomeItem(
		"Error Log", "DocType", "Error Log", "Admin & Maintenance", 20, "admin", "ERPNext Link", "Grey"
	),
	WorkspaceHomeItem(
		"EdgePay Handoff Log",
		"DocType",
	...
	WorkspaceHomeItem(
		"EdgePay Readiness Checklist",
		"Report",
		"RetailEdge EdgePay Readiness Checklist",
		"EdgePay Review",
		145,
		"admin",
		"RetailEdge Native",
