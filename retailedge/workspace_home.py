...
HOME_WORKSPACE_ITEMS: tuple[WorkspaceHomeItem, ...] = (
	...
	WorkspaceHomeItem("Cashier Expenses", "DocType", "RetailEdge Cashier Expense", "Expenses", 10, "cashier", "Business Workspace", "Green"),
	...
	WorkspaceHomeItem("Cashier Expense Review", "Report", "RetailEdge Cashier Expense Review", "Review & Approvals", 30, "approver", "Business Workspace", "Green"),
