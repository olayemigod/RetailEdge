...
HOME_WORKSPACE_ITEMS: tuple[WorkspaceHomeItem, ...] = (
	...
	WorkspaceHomeItem("EdgePay Handoff Log", "DocType", "RetailEdge EdgePay Handoff Log", "EdgePay Review", 10, "reviewer", "RetailEdge Native", "Blue"),
	WorkspaceHomeItem("EdgePay Payment Evidence", "DocType", "RetailEdge EdgePay Payment Evidence", "EdgePay Review", 20, "reviewer", "RetailEdge Native", "Blue"),
