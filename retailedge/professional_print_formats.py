...
_RECEIPT_CSS_58 = _RECEIPT_CSS_80.replace("80mm", "58mm").replace("76mm", "54mm").replace("18mm", "13mm").replace("21mm", "16mm").replace("27mm", "18mm").replace("16mm", "12mm").replace("11pt", "9.5pt").replace("9pt", "8pt").replace("8pt", "7.2pt").replace("7.4pt", "6.6pt")
