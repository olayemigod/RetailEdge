...
from retailedge.payment_application import apply_customer_advance
...
class TestPaymentApplication(unittest.TestCase):
	...
	def test_apply_advance_delegates_write_to_payment_reconciliation(
		self,
		mock_new_doc,
		mock_get_doc,
		_mock_reconcile_permission,
		_mock_read,
		_mock_currency,
		mock_branch_access,
		_mock_invoice_branch,
		_mock_payment_branch,
		mock_db_value,
	):
	...
	@patch("retailedge.payment_application._assert_reconciliation_permission")
	@patch("retailedge.payment_application.frappe.get_doc")
	def test_apply_advance_rejects_customer_company_mismatch(
		self,
		mock_get_doc,
		_mock_permission,
		_mock_read,
	...
	@patch("retailedge.payment_application._assert_reconciliation_permission")
	@patch("retailedge.payment_application.frappe.get_doc")
	def test_apply_advance_rejects_amount_over_available_payment(
		self,
		mock_get_doc,
		_mock_permission,
		_mock_read,
	...
	@patch("retailedge.payment_application._assert_reconciliation_permission")
	@patch("retailedge.payment_application.frappe.get_doc")
	def test_apply_advance_redirects_separate_advance_account_to_full_reconciliation(
		self,
		mock_get_doc,
		_mock_permission,
		_mock_read,
