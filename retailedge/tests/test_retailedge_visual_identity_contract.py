...
APP_ICON = ROOT / "public" / "images" / "processedge_retail" / "pedge-retail-app-icon-blue-v1.svg"
...
def test_approved_processedge_retail_brand_assets_and_visible_identity_are_wired():
    ...
    assert "pedge-retail-app-icon-blue-v1.svg" in hooks
...
def test_desktop_launcher_repairs_existing_frappe_desktop_state_without_renaming_workspace():
    ...
    for contract in (
        ...
        'pedge-retail-app-icon-blue-v1.svg',
        '"Desktop Icon"',
        '"Workspace Sidebar"',
