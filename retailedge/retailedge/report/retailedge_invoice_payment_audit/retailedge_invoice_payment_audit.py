...
def get_columns():
	return [
		...
		{
			"label": _("Payment Row Amount"),
			"fieldname": "payment_row_amount",
			"fieldtype": "Currency",
			"width": 120,
		},
		{
			"label": _("Payment Entry Amount"),
		...
		{
			"label": _("Payment Classification"),
			"fieldname": "payment_classification",
			"fieldtype": "Data",
			"width": 155,
		},
		...
		{
			"label": _("Expected Accounts"),
			"fieldname": "expected_accounts",
			"fieldtype": "Data",
			"width": 180,
		},
...
def get_report_summary(filters):
	...
	return [
		{
			"value": summary.get("total_invoice_count"),
			"label": _("Invoices"),
			"datatype": "Int",
			"indicator": "Blue",
		},
		{
			"value": summary.get("payment_rows_missing_count"),
			"label": _("Missing Payment Rows"),
			"datatype": "Int",
			"indicator": "Orange" if summary.get("payment_rows_missing_count") else "Green",
		},
		{
			"value": summary.get("payment_account_mismatch_count"),
			"label": _("Account Mismatches"),
			"datatype": "Int",
			"indicator": "Red" if summary.get("payment_account_mismatch_count") else "Green",
		},
		{
			"value": summary.get("high_risk_count"),
			"label": _("High Risk"),
			"datatype": "Int",
			"indicator": "Red" if summary.get("high_risk_count") else "Green",
		},
	]
