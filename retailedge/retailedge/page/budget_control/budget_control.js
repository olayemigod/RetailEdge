...
const PAGE_ROUTE = "budget-control";
const PAGE_TITLE = "Budgeting & Cost Control";
const WORKSPACE_KEY = "budget-control";
...
frappe.pages[PAGE_ROUTE].on_page_load = async function (wrapper) {
	...
	loading.textContent = __("Loading Budgeting & Cost Control...");
	...
	try {
		...
		loading.textContent = error?.message || __("Budgeting & Cost Control failed to load.");
