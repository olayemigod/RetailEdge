...
const PAGE_ROUTE = "assets-control";
const PAGE_TITLE = "Assets";
const WORKSPACE_KEY = "assets";
...
frappe.pages[PAGE_ROUTE].on_page_load = async function (wrapper) {
	...
	loading.textContent = __("Loading Assets...");
	...
	try {
		...
		loading.textContent = error?.message || __("Assets failed to load.");
