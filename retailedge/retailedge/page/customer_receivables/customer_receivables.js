...
const RECEIVABLES_ASSET = "customer_receivables.bundle.js";
const PAGE_ROUTE = "customer-receivables";
const PAGE_TITLE = "Customer Receivables";
...
function renderLoadError(wrapper, error) {
	const errorDiv = document.createElement("div"); errorDiv.className = "retailedge-receivables-load-error alert alert-danger p-6 text-center";
