...
const PAGE_ROUTE = "stock-position";
const PAGE_TITLE = "Stock Position";
...
function renderLoadError(wrapper, error) {
	const existing = wrapper.querySelector?.(".retailedge-stock-position-load-error");
	if (existing) existing.remove();
	const errorDiv = document.createElement("div");
	errorDiv.className = "retailedge-stock-position-load-error alert alert-danger p-6 text-center";
