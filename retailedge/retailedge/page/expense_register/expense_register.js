...
const EXPENSE_REGISTER_ASSET = "expense_register.bundle.js";
const PAGE_ROUTE = "expense-register";
const PAGE_TITLE = "Expense Register";
...
function renderLoadError(wrapper, error) {
	const existing = wrapper.querySelector?.(".retailedge-expense-register-load-error");
	if (existing) existing.remove();
	const errorDiv = document.createElement("div");
	errorDiv.className = "retailedge-expense-register-load-error alert alert-danger p-6 text-center";
