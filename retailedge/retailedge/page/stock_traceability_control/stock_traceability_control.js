...
const PAGE_ROUTE = "stock-traceability-control";
const PAGE_TITLE = "Stock Traceability";
const WORKSPACE_KEY = "stock-traceability";
...
frappe.pages[PAGE_ROUTE].on_page_load = async function (wrapper) {
	...
	loading.textContent = __("Loading Stock Traceability...");
	...
	try {
		...
		loading.textContent = error?.message || __("Stock Traceability failed to load.");
