...
frappe.pages[PAGE_ROUTE].on_page_load = async function (wrapper) {
	...
	try {
		...
		bootLoading.remove(); const root = document.createElement("div"); root.className = "retailedge-purchase-report-root"; page.body.append(root); await window.mountPurchaseReportingPage(root, { reportType: REPORT_TYPE });
