...
const PURCHASE_REPORTING_ASSET = "purchase_reporting.bundle.js";
const PAGE_ROUTE = "supplier-payables";
const REPORT_TYPE = "supplier_payables";
const PAGE_TITLE = "Supplier Payables";
...
function renderLoadError(wrapper, error) {
	const errorDiv = document.createElement("div"); errorDiv.className = "retailedge-purchase-report-load-error alert alert-danger p-6 text-center";
