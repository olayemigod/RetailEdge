...
export default {
	...
	data() { return { edgeUIValid: true, missingComponents: [], loading: false, loaded: false, error: "", tenantName: "", branchName: "", userName: "", menuItems: [], canUseNativeDesk: false, documents: [], selectedDocumentKey: "", searchText: "", searching: false, searchAttempted: false, searchResults: [], detailsLoading: false, details: null, printFormat: "Standard", useLetterhead: true, emailRecipient: "", emailSubject: "", emailMessage: "", sendingEmail: false, preparingWhatsApp: false, searchTimer: null }; },
	computed: {
