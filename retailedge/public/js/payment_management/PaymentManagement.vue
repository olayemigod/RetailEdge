...
export default {
	...
	methods: {
		...
		formatCurrency(value, currency = "") { try { return window.retailedge.formatPlainValue(Number(value || 0), { fieldtype: "Currency", options: currency || this.context.currency || this.settlement.context.currency || "" }); } catch (_error) { return Number(value || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }); } },
