		...
		<section class="project-page">
			...
			<section class="project-panel">
				<div class="filter-grid">
					...
					<EdgeLinkField v-model="branch" :selectedLabel="branchLabel" label="Branch" placeholder="Optional branch scope" :disabled="!projectCompany" :searcher="branchSearch" @select="onBranchSelected" @clear="clearBranch" />
