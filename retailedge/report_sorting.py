...
REPORT_SORT_FIELDS: dict[str, frozenset[str]] = {
	...
	"sales-analysis": frozenset({"group_label", "sold_qty", "returned_qty", "net_qty", "sales_value", "returns_value", "net_sales", "invoice_count", "average_selling_price", "recorded_cost", "gross_profit", "gross_margin_percent", "missing_recorded_cost"}),
